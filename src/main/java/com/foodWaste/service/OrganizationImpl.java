	...
	public Organization_Entity upadteOrganizationById(int Organization_Entity, Organization_Entity organization) {
		...
		if (o1.isPresent()) {
			...
			Organization_Entity originalorga = o1.get();
			 ...
			 if (Objects.nonNull(organization.getOrganization_type()) && !"".equalsIgnoreCase(organization.getOrganization_type())) {
				 originalorga.setOrganization_type(organization.getOrganization_type());;
	            }
